                  ...
                  {submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <button
                        ...
                        className="w-full bg-sage text-white px-8 py-4 rounded-full font-medium hover:bg-sage-dark transition-all inline-flex items-center justify-center gap-2 disabled:cursor-not-allowed disabled:opacity-70"
                      >
